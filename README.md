# Hi, I'm Muhammed Çağan Göktaş 👋

Second-year CS & Mathematics student at Koç University (GPA: 3.84/4.00). Research assistant at Spade Lab, working on data privacy and security.
...
`Python` `PyTorch` `scikit-learn` `LightGBM` `FAISS`

**[Salamander Species Classification](https://github.com/mcagangoktas/salamander-species-classification)**
Classified two endangered, closely related salamander species endemic to Turkey using pheromone scent data from an electronic nose system and ML classifiers (ANN, SVM, Decision Trees, Logistic Regression) — best model reached 86.67% accuracy. 🥇 1st Place, MEF Research Competition (Biology, 2023) · presented at the 22nd European Congress of Herpetology, UK.
